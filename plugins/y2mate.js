...
bot(
  ...
  async (message, match) => {
    ...
    if (!buttons.length)
      return await message.send('*This Youtube video does Not exist*,~FOUND~', {
...
bot(
  ...
  async (message, match) => {
    ...
    if (!result) return await message.send(`*This Youtube audio does Not exist*,~FOUND~`, { quoted: message.data })
